...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon.ico?v=3", sizes: "16x16 32x32", type: "image/x-icon" },
      {
      ...
      {
        url: "/favicon-dark-32x32.png?v=3",
        sizes: "32x32",
        type: "image/png",
        media: "(prefers-color-scheme: dark)",
      },
      { url: "/icons/class-status-icon-192.png?v=3", sizes: "192x192", type: "image/png" },
      { url: "/icons/class-status-icon-512.png?v=3", sizes: "512x512", type: "image/png" },
    ],
    shortcut: "/favicon.ico?v=3",
    apple: [{ url: "/icons/class-status-apple-touch-icon.png?v=3", sizes: "180x180", type: "image/png" }],
  },
  appleWebApp: {
    capable: true,
