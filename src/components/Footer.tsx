...
import { ShieldCheck, Clock, MapPin, ExternalLink, Heart } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl 2xl:max-w-[min(90vw,1920px)] px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5">
              <li className="flex items-center gap-1.5">
                ...
                <span>All 17 NCR Cities & Municipalities</span>
              </li>
              <li className="flex items-center gap-1.5">
                <Clock className="h-3 w-3 text-emerald-500" />
                <span>Synchronized to Asia/Manila (UTC+8)</span>
              </li>
              <li>
                <span>Active, Upcoming & Expired lifecycle parsing</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/sources" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Collector Sources
                </Link>
              </li>
              <li>
